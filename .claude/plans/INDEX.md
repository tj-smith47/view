...
| Migration integrity (capability probing, surface ownership, compat evidence, notification surface) | `2026-08-20-migration-integrity-charters.md` (charter format per `2026-07-18-p3-p6-charters.md`; origin: first release-binary dogfood over SSH, 2026-08-20) | Chartered (2026-08-20; start-gated on P5 completion, user-ruled) |
