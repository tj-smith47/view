...
| P5 AI (ACP client, panel, diff review) | `2026-08-09-p5-ai.md` (charter: `2026-07-18-p3-p6-charters.md`; ACP v1 verified against live spec at plan time) | Complete (all 21 tasks through SDD review loops; fable whole-branch review + scoped re-review closed at SHIP 2026-08-21; exit checklist closed per-box with evidence and an Exit record in the plan; conformance 7/7 legs against adapter 0.69.0; live dogfood journaled) |
...
| P6 Polish, multigrid, doctor, Windows tier-1 (= v0.1) | `2026-08-21-p6-polish.md` (charter: `2026-07-18-p3-p6-charters.md`; carries P5's four recorded deferrals as starting inputs; all three planning-time open questions user-ruled 2026-08-21) | Planned (2026-08-21; fable-reviewed to SHIP; start-gated on migration integrity, user-ruled) |
...
| **Roadmap restructure (one release, dependency-grouped streaks S1–S9)** | `2026-09-04-roadmap-restructure.md` | Binding order from 2026-09-04 (user ruling: no v0.1.0 goalpost, every known feature in the initial release; one streak per session; strict briefs, opus implementers, Fable reviews on screen-level work). Supersedes the phase table's v0.1/v0.2 split for scheduling. |
...
| S3 Tiled UI (roadmap streak) | `2026-09-20-s3-tiled-ui.md` | Design doc SHIP after four Fable review rounds (2026-09-20; ledger `.superpowers/sdd/2026-09-20-s3-tiled-ui/`); tasks in progress |
