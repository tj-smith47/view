...
| P2 Elm core + Surface + tiers + ext layers | `2026-07-18-p2-elm-runtime.md` | In execution (adversarially reviewed, 3 rounds) |
| P3 Oracle + compat suite + bench CI gates | `2026-07-18-p3-oracle-bench-gates.md` (charter: `2026-07-18-p3-p6-charters.md`) | Approved for execution (adversarial review, 2 rounds) |
| P4 Native features + theming | `2026-07-26-p4-native-features.md` (charter: `2026-07-18-p3-p6-charters.md`) | **DRAFT — awaiting adversarial review (protocol step 5)** |
