...
**Goal:** the editor that cannot freeze (spec:617, §9 invented capability,
v0.1 CORE — ruled 2026-08-05, spec:898, no "post-v0.1" framing anywhere in
...
P5.5 alongside P3 remote editing (spec:610-611, `HANDOFF.md:67-68`).
...
- **v0.1 framing: this is a CORE v0.1 feature** (2026-08-05 ruling,
  spec:898) — no task, comment, or commit message in this plan uses
...
- [x] Spec-amendment check: this plan touches no owed spec amendment.
      Verified against `invention-research.md:§1.4,§6.2` — spec:345-348
      ...
      research package is the media-handoff row at `spec:622`, out of
