...
| 21 | surface the adjudication list to the user | SURFACED 2026-08-03 (full list = 3.4 items 1-11 + campaign items (a)-(d) + carried bench-leak/auto-staleness + infra notes). Awaiting the user's decisions; nothing has been pushed |
