...
| Sustained scroll, 100k-line file, tier full (`scroll.staleness_p99_ms`, `flood.cadence_p99_ms`) | content staleness p99 ≤ 16 ms (input → corresponding scrolled content on screen) | frame log w/ staleness tags |
