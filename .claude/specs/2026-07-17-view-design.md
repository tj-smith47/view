...
stable within 7 % across load regimes whose tails swung 300-fold):
...
the 2026-07-27 budget ruling (marker p99 ≤ 30 ms, ratio_p50 ≤ 0.30 of the
paired bare-nvim run) already
