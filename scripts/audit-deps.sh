...
for dep in view-engine view-tui view-surface view-native view-ai view-oracle view-bench rmpv crossterm ratatui tokio async-std smol; do
  check_absent view-core "$dep"
done
for dep in view-engine view-tui view-native view-ai view-oracle view-bench tokio async-std smol; do
  check_absent view-surface "$dep"
done
for crate in view-native view-ai; do
  for dep in view-engine view-tui view-oracle view-bench tokio async-std smol; do
